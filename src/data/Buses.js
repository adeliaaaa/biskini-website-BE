exports.Buses = [
  {
    ...
    schedules: [
      ...
      {
        departureTime: 600,
        seatAvailable: [11, 13, 16, 18, 22, 24, 27, 29],
        price: 16000,
      },
      {
        departureTime: 750,
        seatAvailable: [2, 5, 7, 18, 22, 24, 27, 29],
        price: 20000,
      },
      {
        departureTime: 840,
        seatAvailable: [5, 7, 9, 11, 13, 16, 18, 22, 24, 27, 29],
        price: 18000,
      },
      {
        departureTime: 990,
        seatAvailable: [3, 5, 7, 9, 11, 13, 16, 18, 20, 22, 24, 26],
        price: 20000,
      },
      {
        departureTime: 1080,
  ...
  },
  {
    ...
    schedules: [
      ...
      {
        departureTime: 700,
        seatAvailable: [2, 5, 7, 9, 11],
        price: 16000,
      },
      {
        departureTime: 800,
        seatAvailable: [2, 6, 9, 12, 15, 17, 19],
        price: 20000,
      },
      {
        departureTime: 900,
        seatAvailable: [2, 5, 11, 13, 16, 18, 20, 22, 24, 26],
        price: 18000,
      },
      {
        departureTime: 10000,
